...
// Используется для аутентификации и персонализации
// Поля:
// - ID: уникальный идентификатор пользователя
// - Name: полное имя пользователя
// - Nickname: уникальный никнейм пользователя
// - CreatedAt: дата и время регистрации
// - LastLogin: дата и время последнего входа
// Поля CreatedAt и LastLogin автоматически обновляются базой данных
type User struct {
	ID        int    `json:"id"`
